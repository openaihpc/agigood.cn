const translation = {
  list: {
    title: 'Documentos',
    desc: 'Aquí se muestran todos los archivos del Conocimiento, y todo el Conocimiento se puede vincular a citas de CASGV o indexarse a través del complemento de Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV descargará periódicamente archivos desde tu Notion y completará el procesamiento.',
      },
    },
    delete: {
