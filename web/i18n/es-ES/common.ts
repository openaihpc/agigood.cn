const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta CASGV',
    langGeniusAccountTip: 'Tu cuenta CASGV y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en CASGV para acceder a tus datos del equipo.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'El servicio de hospedaje OpenAI proporcionado por CASGV te permite usar modelos como GPT-3.5. Antes de que se agote tu cuota de prueba, necesitas configurar otros proveedores de modelos.',
  ...
  apiBasedExtension: {
    title: 'Las extensiones basadas en API proporcionan una gestión centralizada de API, simplificando la configuración para su fácil uso en las aplicaciones de CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} ya está disponible.',
    latestAvailable: 'CASGV {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
