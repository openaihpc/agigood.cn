const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se refiere al número de llamadas API que invocan solo las capacidades de procesamiento de base de conocimientos de CASGV.',
    ...
    apiRateLimitTooltip: 'El límite de tasa de la API se aplica a todas las solicitudes realizadas a través de la API de CASGV, incluidos la generación de texto, las conversaciones de chat, las ejecuciones de flujo de trabajo y el procesamiento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Actualizaciones y Mantenimiento por CASGV Oficialmente',
        ...
        5: 'SLA negociados por CASGV Partners',
        4: 'SSO',
    ...
    community: {
      features: {
        ...
        2: 'Cumple con la Licencia de Código Abierto de CASGV',
