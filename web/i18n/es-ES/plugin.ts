const translation = {
  ...
  marketplace: {
    ...
    discover: 'Descubrir',
    and: 'y',
    difyMarketplace: 'Mercado de CASGV',
    verifiedTip: 'Verificado por CASGV',
    partnerTip: 'Verificado por un socio de CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'La versión actual de CASGV no es compatible con este plugin, por favor actualiza a la versión mínima requerida: {{minimalCASGVVersion}}',
}
