const translation = {
  ...
  didYouKnow: '¿Sabías?',
  intro1: 'El Conocimiento se puede integrar en la aplicación CASGV ',
  ...
  externalAPIPanelDescription: 'La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de CASGV y recuperar conocimiento de esa base de conocimiento.',
