const translation = {
  ...
  welcome: 'Bienvenido a CASGV, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con CASGV Community Edition, lee la',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en CASGV y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de CASGV Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando CASGV.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de CASGV Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando CASGV.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando CASGV.',
}
