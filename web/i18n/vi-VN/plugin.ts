const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    difyMarketplace: 'Thị trường CASGV',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi CASGV',
    partnerTip: 'Được xác nhận bởi một đối tác của CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Phiên bản CASGV hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalCASGVVersion}}',
}
