const translation = {
  ...
  welcome: 'Chào mừng bạn đến với CASGV, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ email',
  ...
  license: {
    tip: 'Trước khi bắt đầu sử dụng Phiên bản Cộng đồng của CASGV, vui lòng đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội ngũ tại CASGV',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá CASGV',
  ...
  or: 'HOẶC',
  resetPasswordDesc: 'Nhập email bạn đã sử dụng để đăng ký trên CASGV và chúng tôi sẽ gửi cho bạn email đặt lại mật khẩu.',
  ...
  licenseInactiveTip: 'Giấy phép CASGV Enterprise cho không gian làm việc của bạn không hoạt động. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng CASGV.',
  licenseExpired: 'Giấy phép đã hết hạn',
  licenseExpiredTip: 'Giấy phép CASGV Enterprise cho không gian làm việc của bạn đã hết hạn. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng CASGV.',
  licenseLostTip: 'Không thể kết nối máy chủ cấp phép CASGV. Vui lòng liên hệ với quản trị viên của bạn để tiếp tục sử dụng CASGV.',
}
