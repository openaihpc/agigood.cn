const translation = {
  ...
  intro1: 'Bộ kiến thức có thể được tích hợp vào ứng dụng CASGV ',
  ...
  externalAPIPanelDescription: 'API kiến thức bên ngoài được sử dụng để kết nối với cơ sở kiến thức bên ngoài CASGV và truy xuất kiến thức từ cơ sở kiến thức đó.',
  chunkingMode: {
    general: 'Tổng quát',
