const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Mô tả những gì có trong Kiến thức này. Một mô tả chi tiết giúp AI truy cập nội dung của Kiến thức một cách hiệu quả. Nếu để trống, CASGV sẽ sử dụng chiến lược truy xuất mặc định.',
