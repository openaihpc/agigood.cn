const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Hoặc dùng thử phiên bản đám mây của CASGV với gói miễn phí',
  },
  overview: {
    title: 'Tổng quan',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Giúp người dùng hiểu dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Cài đặt tiện ích mở rộng CASGV Chatbot cho Chrome',
        copied: 'Đã sao chép',
        copy: 'Sao chép',
      },
      qrcode: {
