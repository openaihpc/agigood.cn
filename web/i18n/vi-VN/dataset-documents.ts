const translation = {
  list: {
    title: 'Tài liệu',
    desc: 'Tất cả các tệp của Kiến thức được hiển thị ở đây. Toàn bộ Kiến thức có thể được liên kết với trích dẫn của CASGV hoặc được lập chỉ mục thông qua plugin Chat.',
    addFile: 'Thêm tệp',
    addPages: 'Thêm trang',
    table: {
      header: {
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV sẽ định kỳ tải xuống tệp từ Notion của bạn và hoàn tất xử lý.',
      },
    },
    delete: {
