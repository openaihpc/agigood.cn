const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Đề cập đến số lượng cuộc gọi API triệu hồi chỉ khả năng xử lý cơ sở kiến thức của CASGV.',
    ...
    apiRateLimitTooltip: 'Giới hạn tần suất API áp dụng cho tất cả các yêu cầu được thực hiện thông qua API CASGV, bao gồm tạo văn bản, cuộc trò chuyện, thực thi quy trình làm việc và xử lý tài liệu.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Cập nhật và Bảo trì bởi CASGV Chính thức',
        5: 'Thỏa thuận SLA bởi các đối tác CASGV',
    ...
    community: {
      features: {
        2: 'Tuân thủ Giấy phép Mã nguồn Mở CASGV',
