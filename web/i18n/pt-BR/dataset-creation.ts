const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Atualmente, a base de conhecimento da CASGV possui apenas fontes de dados limitadas. Contribuir com uma fonte de dados para a base de conhecimento CASGV é uma maneira fantástica de ajudar a aumentar a flexibilidade e o poder da plataforma para todos os usuários. Nosso guia de contribuição facilita o início. Clique no link abaixo para saber mais.',
