const translation = {
  ...
  welcome: 'Bem-vindo ao CASGV, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do CASGV, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no CASGV',
  invalid: 'O link expirou',
  explore: 'Explorar o CASGV',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no CASGV e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do CASGV Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o CASGV.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças CASGV. Entre em contato com o administrador para continuar usando o CASGV.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do CASGV Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o CASGV.',
}
