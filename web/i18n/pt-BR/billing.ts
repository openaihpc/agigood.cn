const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do CASGV.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API CASGV, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Atualizações e Manutenção por CASGV Oficialmente',
        5: 'Acordos de Nível de Serviço negociados pelos Parceiros CASGV',
    ...
    community: {
      features: {
        ...
        2: 'Cumpre a Licença de Código Aberto CASGV',
      },
      name: 'Comunidade',
