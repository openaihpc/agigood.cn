const translation = {
  list: {
    title: 'Documentos',
    desc: 'Todos os arquivos do Knowledge são mostrados aqui, e todo o Knowledge pode ser vinculado a citações do CASGV ou indexado por meio do plugin Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'O CASGV baixará periodicamente arquivos do seu Notion e concluirá o processamento.',
      },
    },
    delete: {
