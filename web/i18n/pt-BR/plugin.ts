const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Mercado CASGV',
    moreFrom: 'Mais do Marketplace',
    noPluginFound: 'Nenhum plugin encontrado',
    discover: 'Descobrir',
    verifiedTip: 'Verificado pelo CASGV',
    partnerTip: 'Verificado por um parceiro da CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'A versão atual do CASGV não é compatível com este plugin, por favor atualize para a versão mínima exigida: {{minimalCASGVVersion}}',
}
