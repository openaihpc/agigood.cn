const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Conta CASGV',
    langGeniusAccountTip: 'Sua conta CASGV e dados de usuário associados.',
  ...
  members: {
    ...
    invitationSentTip: 'Convite enviado e eles podem fazer login no CASGV para acessar os dados da sua equipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'O serviço de hospedagem OpenAI fornecido pela CASGV permite que você use modelos como GPT-3.5. Antes que sua cota de teste seja esgotada, você precisa configurar outros fornecedores de modelos.',
      callTimes: 'Chamadas',
  ...
  apiBasedExtension: {
    title: 'As extensões de API fornecem gerenciamento centralizado de API, simplificando a configuração para uso fácil em todos os aplicativos da CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} já está disponível.',
    latestAvailable: 'CASGV {{version}} é a última versão disponível.',
  },
  appMenus: {
