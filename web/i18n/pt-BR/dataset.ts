const translation = {
  ...
  intro1: 'O Conhecimento pode ser integrado ao aplicativo CASGV ',
  ...
  externalAPIPanelDescription: 'A API de conhecimento externo é usada para se conectar a uma base de conhecimento fora do CASGV e recuperar o conhecimento dessa base de conhecimento.',
