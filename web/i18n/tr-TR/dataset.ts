const translation = {
  ...
  intro1: 'Bilgi, CASGV uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, CASGV dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
