const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Bu Bilginin içeriğini açıklayın. Ayrıntılı bir açıklama, AI\'nın Bilginin içeriğine zamanında erişmesini sağlar. Boş bırakılırsa, CASGV varsayılan isabet stratejisini kullanır.',
