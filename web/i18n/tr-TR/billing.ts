const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'CASGV\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'CASGV API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'CASGV Tarafından Resmi Güncellemeler ve Bakım',
        5: 'CASGV Ortakları tarafından müzakere edilen SLA\'lar',
    ...
    community: {
      features: {
        ...
        2: 'CASGV Açık Kaynak Lisansına uyar',
      },
      price: 'Ücretsiz',
