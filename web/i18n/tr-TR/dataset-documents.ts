const translation = {
  list: {
    title: 'Belgeler',
    desc: 'Bilginin tüm dosyaları burada gösterilir ve Bilginin tamamı CASGV alıntılarına veya Sohbet eklentisi üzerinden dizine eklenebilir.',
    addFile: 'Dosya Ekle',
    addPages: 'Sayfa Ekle',
    addUrl: 'URL Ekle',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV, Notion\'dan periyodik olarak dosyaları indirir ve işlemeyi tamamlar.',
      },
    },
    delete: {
