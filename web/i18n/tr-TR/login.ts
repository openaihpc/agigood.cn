const translation = {
  ...
  welcome: 'CASGV\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'CASGV Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'CASGV\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için CASGV Enterprise lisansının süresi doldu. CASGV\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'CASGV lisans sunucusuna bağlanılamadı. CASGV\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için CASGV Enterprise lisansı etkin değil. CASGV\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
