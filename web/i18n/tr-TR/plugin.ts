const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'CASGV Pazar Yeri',
    sortBy: 'Kara şehir',
    moreFrom: 'Marketplace\'ten daha fazlası',
    noPluginFound: 'Eklenti bulunamadı',
    viewMore: 'Daha fazla göster',
    discover: 'Keşfetmek',
    verifiedTip: 'CASGV tarafından doğrulanmıştır.',
    partnerTip: 'CASGV partner\'ı tarafından doğrulandı',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Mevcut CASGV sürümü bu eklentiyle uyumlu değil, lütfen gerekli minimum sürüme güncelleyin: {{minimalCASGVVersion}}',
}
