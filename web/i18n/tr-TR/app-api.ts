const translation = {
  ...
  completionMode: {
    ...
    info: 'Makale, özet ve çeviri gibi yüksek kaliteli metin üretimi için, completion-messages API\'sini kullanıcı girişi ile birlikte kullanın. Metin üretimi, CASGV Prompt Engineering\'de ayarlanan model parametrelerine ve prompt şablonlarına dayanır.',
  ...
  chatMode: {
    ...
    info: 'Soru-Cevap formatını kullanan çok yönlü sohbet uygulamaları için, diyalogu başlatmak üzere chat-messages API\'sini çağırın. conversation_id\'yi ileterek devam eden konuşmaları sürdürün. Yanıt parametreleri ve şablonları, CASGV Prompt Engineering ayarlarına bağlıdır.',
