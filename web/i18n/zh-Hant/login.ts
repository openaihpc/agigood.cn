const translation = {
  ...
  license: {
    tip: '啟動 CASGV 社群版之前, 請閱讀 GitHub 上的',
    link: '開源協議',
  },
  join: '加入',
  joinTipStart: '邀請你加入',
  ...
  withSSO: '繼續使用 SSO',
  back: '返回',
  resetPasswordDesc: '輸入您用於註冊 CASGV 的電子郵件，我們將向您發送一封密碼重置電子郵件。',
  usePassword: '使用密碼',
  licenseExpiredTip: '您的工作區的 CASGV Enterprise 許可證已過期。請聯繫您的管理員以繼續使用 CASGV。',
  licenseExpired: '許可證已過期',
  licenseLost: '許可證丟失',
  licenseInactive: '許可證處於非活動狀態',
  licenseInactiveTip: '您的工作區的 CASGV Enterprise 許可證處於非活動狀態。請聯繫您的管理員以繼續使用 CASGV。',
  licenseLostTip: '無法連接 CASGV 許可證伺服器。請聯繫您的管理員以繼續使用 CASGV。',
}
