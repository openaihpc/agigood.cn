const translation = {
  ...
  apiKeyInfo: {
    ...
    usedToken: '使用 Tokens',
    setAPIBtn: '設定模型提供商',
    tryCloud: '或者嘗試使用 CASGV 的雲版本並使用試用配額',
  },
  overview: {
    title: '概覽',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '幫助訪問者瞭解該應用收集的資料，可參考 CASGV 的<privacyPolicyLink>隱私政策</privacyPolicyLink>。',
      ...
      embedded: {
        ...
        chromePlugin: '安裝 CASGV Chrome 瀏覽器擴充套件',
        copied: '已複製',
        copy: '複製',
      },
      qrcode: {
