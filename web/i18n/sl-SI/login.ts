const translation = {
  ...
  welcome: 'Dobrodošli v CASGV, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z CASGV Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na CASGV',
  invalid: 'Povezava je potekla',
  explore: 'Razišči CASGV',
  ...
  licenseExpiredTip: 'Licenca za CASGV Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati CASGV, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na CASGV, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom CASGV ni uspela. Če želite še naprej uporabljati CASGV, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca CASGV Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati CASGV, se obrnite na skrbnika.',
}
