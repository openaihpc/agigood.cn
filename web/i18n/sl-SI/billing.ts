const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Nanaša se na število API klicev, ki vključujejo samo sposobnosti obdelave baze znanja CASGV.',
    ...
    apiRateLimitTooltip: 'API omejitev hitrosti velja za vse poizvedbe, opravljene prek CASGV API, vključno z generiranjem besedila, klepetnimi pogovori, izvajanjem delovnih tokov in obdelavo dokumentov.',
  ...
  plans: {
    ...
    community: {
      features: {
        2: 'Upošteva CASGV odprtokodno licenco',
