const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'CASGV račun',
    langGeniusAccountTip: 'Vaš CASGV račun in povezani uporabniški podatki.',
    editName: 'Uredi ime',
  ...
  members: {
    ...
    invitationSentTip: 'Povabilo poslano, in po prijavi v CASGV bodo imeli dostop do vaših podatkov ekipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Gostitvena storitev OpenAI, ki jo ponuja CASGV, vam omogoča uporabo modelov, kot je GPT-3.5. Preden porabite kvoto za preizkus, morate nastaviti druge ponudnike modelov.',
  ...
  modelProvider: {
    ...
    apiBasedExtension: {
      title: 'Razširitve API omogočajo centralizirano upravljanje API, kar poenostavi konfiguracijo za enostavno uporabo v aplikacijah CASGV.',
    ...
    about: {
      ...
      nowAvailable: 'CASGV {{version}} je zdaj na voljo.',
      latestAvailable: 'CASGV {{version}} je najnovejša različica na voljo.',
    },
    appMenus: {
      overview: 'Nadzor',
  ...
  apiBasedExtension: {
    ...
    title: 'Razširitve API zagotavljajo centralizirano upravljanje API, kar poenostavlja konfiguracijo za enostavno uporabo v aplikacijah CASGV.',
    linkUrl: 'https://docs.dify.ai/en/guides/extension/api-based-extension/README',
  ...
  about: {
    updateNow: 'Posodobi zdaj',
    nowAvailable: 'CASGV {{version}} je zdaj na voljo.',
    latestAvailable: 'CASGV {{version}} je najnovejša različica, ki je na voljo.',
    changeLog: 'Dnevnik sprememb',
  },
  appMenus: {
