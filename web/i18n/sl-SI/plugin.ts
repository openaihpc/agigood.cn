const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani CASGV',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja CASGV',
    ...
    difyMarketplace: 'CASGV Marketplace',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Trenutna različica CASGV ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalCASGVVersion}}',
}
