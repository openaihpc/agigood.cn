const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ali preizkusite oblačno različico CASGV s prosto kvoto',
  },
  overview: {
    title: 'Pregled',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Pomaga obiskovalcem razumeti, katere podatke aplikacija zbira, glejte <privacyPolicyLink>politiko zasebnosti</privacyPolicyLink> CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Namestite CASGV Chatbot razširitev za Chrome',
        copied: 'Kopirano',
        copy: 'Kopiraj',
      },
      qrcode: {
