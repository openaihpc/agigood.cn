const translation = {
  list: {
    title: 'Dokumenti',
    desc: 'Vse datoteke znanja so prikazane tukaj, celotno znanje pa je mogoče povezati s citati CASGV ali indeksirati prek vtičnika Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV bo občasno prenesel datoteke iz Notion in dokončal obdelavo.',
      },
    },
    delete: {
