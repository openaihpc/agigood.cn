const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'काला शहर',
    discover: 'खोजें',
    partnerTip: 'CASGV भागीदार द्वारा सत्यापित',
  ...
  difyVersionNotCompatible: 'वर्तमान डिफाई संस्करण इस प्लगइन के साथ संगत नहीं है, कृपया आवश्यक न्यूनतम संस्करण में अपग्रेड करें: {{minimalCASGVVersion}}',
}
