const translation = {
  ...
  welcome: 'CASGV में आपका स्वागत है, कृपया जारी रखने के लिए लॉग इन करें।',
  email: 'ईमेल पता',
  ...
  license: {
    tip: 'CASGV Community Edition शुरू करने से पहले, GitHub पर',
    link: 'ओपन-सोर्स लाइसेंस',
  },
  join: 'शामिल हों',
  joinTipStart: 'आपको आमंत्रित करते हैं',
  joinTipEnd: 'टीम पर CASGV',
  invalid: 'लिंक समाप्त हो गया है',
  explore: 'CASGV का अन्वेषण करें',
  ...
  resetPasswordDesc: 'वह ईमेल टाइप करें जिसका उपयोग आपने CASGV पर साइन अप करने के लिए किया था और हम आपको एक पासवर्ड रीसेट ईमेल भेजेंगे।',
  ...
  licenseLostTip: 'CASGV लायसेंस सर्वर से कनेक्ट करने में विफल. CASGV का उपयोग जारी रखने के लिए कृपया अपने व्यवस्थापक से संपर्क करें.',
