const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'या मुफ्त कोटा के साथ CASGV का क्लाउड संस्करण आज़माएं',
  },
  overview: {
    title: 'अवलोकन',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'आगंतुकों को यह समझने में मदद करता है कि एप्लिकेशन कौन सा डेटा एकत्र करता है, देखें CASGV की <privacyPolicyLink>गोपनीयता नीति</privacyPolicyLink>।',
      ...
      embedded: {
        ...
        chromePlugin: 'CASGV चैटबॉट क्रोम एक्सटेंशन इंस्टॉल करें',
