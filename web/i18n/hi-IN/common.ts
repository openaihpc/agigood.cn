const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'CASGV खाता',
    langGeniusAccountTip: 'आपका CASGV खाता और संबंधित उपयोगकर्ता डेटा।',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'CASGV द्वारा प्रदान की गई OpenAI होस्टिंग सेवा आपको GPT-3.5 जैसे मॉडल का उपयोग करने की अनुमति देती है। आपके परीक्षण कोटा के समाप्त होने से पहले, आपको अन्य मॉडल प्रदाताओं को सेट करने की आवश्यकता है।',
      callTimes: 'कॉल बार',
  ...
  apiBasedExtension: {
    title:
      'एपीआई एक्सटेंशन केंद्रीकृत एपीआई प्रबंधन प्रदान करते हैं, जो CASGV के अनुप्रयोगों में आसान उपयोग के लिए कॉन्फ़िगरेशन को सरल बनाते हैं।',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} अब उपलब्ध है।',
    latestAvailable: 'CASGV {{version}} नवीनतम उपलब्ध संस्करण है।',
  },
  appMenus: {
    overview: 'निगरानी',
