const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Lub wypróbuj wersję chmurową CASGV z darmowym limitem',
  },
  overview: {
    title: 'Przegląd',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności CASGV</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Zainstaluj rozszerzenie Chrome CASGV Chatbot',
        copied: 'Skopiowane',
        copy: 'Kopiuj',
      },
      qrcode: {
