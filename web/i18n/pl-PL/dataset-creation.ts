const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Obecnie baza wiedzy CASGV ma tylko ograniczone źródła danych. Dodanie źródła danych do bazy wiedzy CASGV to fantastyczny sposób na zwiększenie elastyczności i możliwości platformy dla wszystkich użytkowników. Nasz przewodnik po wkładach ułatwia rozpoczęcie pracy. Kliknij poniższy link, aby dowiedzieć się więcej.',
  },
  watercrawl: {
