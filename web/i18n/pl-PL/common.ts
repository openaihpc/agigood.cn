const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto CASGV',
    langGeniusAccountTip: 'Twoje konto CASGV i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do CASGV, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez CASGV pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} jest teraz dostępny.',
    latestAvailable: 'CASGV {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
