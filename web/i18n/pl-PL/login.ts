const translation = {
  ...
  welcome: 'Witaj w CASGV, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej CASGV, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na CASGV',
  invalid: 'Link wygasł',
  explore: 'Odkryj CASGV',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w CASGV, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja CASGV Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z CASGV.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji CASGV. Skontaktuj się z administratorem, aby kontynuować korzystanie z CASGV.',
  licenseInactiveTip: 'Licencja CASGV Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z CASGV.',
}
