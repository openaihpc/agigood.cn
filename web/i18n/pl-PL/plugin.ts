const translation = {
  ...
  marketplace: {
    ...
    and: 'i',
    difyMarketplace: 'Rynek CASGV',
    noPluginFound: 'Nie znaleziono wtyczki',
    pluginsResult: '{{num}} wyniki',
    partnerTip: 'Zweryfikowane przez partnera CASGV',
    verifiedTip: 'Zweryfikowane przez CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Obecna wersja CASGV nie jest kompatybilna z tym wtyczką, proszę zaktualizować do minimalnej wymaganej wersji: {{minimalCASGVVersion}}',
}
