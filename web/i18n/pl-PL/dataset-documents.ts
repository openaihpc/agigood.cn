const translation = {
  list: {
    title: 'Dokumenty',
    desc: 'Wszystkie pliki wiedzy są tutaj pokazane, a cała wiedza może być powiązana z odnośnikami CASGV lub zindeksowana za pomocą wtyczki Chat.',
    addFile: 'dodaj plik',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV regularnie pobiera pliki z Twojego Notion i dokonuje ich przetwarzania.',
      },
    },
    delete: {
