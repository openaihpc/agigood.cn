const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją CASGV ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza CASGV i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
