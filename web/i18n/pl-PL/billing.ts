const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      'Odnosi się do liczby wywołań API wykorzystujących tylko zdolności przetwarzania bazy wiedzy CASGV.',
    receiptInfo:
    ...
    self: 'Samo-hostowane',
    apiRateLimitTooltip: 'Limit aktywności API dotyczy wszystkich żądań składanych za pośrednictwem API CASGV, w tym generowania tekstu, rozmów czatowych, wykonywania przepływów pracy i przetwarzania dokumentów.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'Wynegocjowane SLA przez CASGV Partners',
        ...
        7: 'Aktualizacje i konserwacja przez CASGV Oficjalnie',
        4: 'SSO',
    ...
    community: {
      features: {
        ...
        2: 'Zgodne z licencją CASGV Open Source',
      },
