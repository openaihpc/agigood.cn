const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'APIレート制限は、テキスト生成、チャットボット、ワークフロー、ドキュメント処理など、CASGV API経由のすべてのリクエストに適用されます。',
    ...
    ragAPIRequestTooltip: 'CASGVのナレッジベース処理機能のみを呼び出すAPI呼び出しの数を指します。',
