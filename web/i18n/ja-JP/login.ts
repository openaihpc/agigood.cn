const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'CASGVへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、CASGV Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'CASGVへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの CASGV Enterprise ライセンスの有効期限が切れています。CASGVを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの CASGV Enterprise ライセンスが非アクティブです。CASGVを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'CASGVライセンスサーバーへの接続に失敗しました。続けてCASGVを使用するために管理者に連絡してください。',
}
