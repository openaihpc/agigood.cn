const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    difyMarketplace: 'CASGVマーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインはCASGVによって認証されています',
    partnerTip: 'このプラグインはCASGVのパートナーによって認証されています',
  },
  task: {
  ...
  difyVersionNotCompatible: '現在のCASGVバージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalCASGVVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
}
