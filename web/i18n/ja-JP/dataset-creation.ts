const translation = {
  ...
  otherDataSource: {
    ...
    description: '現在、CASGVのナレッジベースには利用できるデータソースが限られています。CASGVのナレッジベースにデータソースを提供いただくことは、プラットフォームの柔軟性と能力を向上させる上で非常に有益です。貢献ガイドをご用意していますので、ぜひご協力ください。詳細については、以下のリンクをクリックしてください。',
    learnMore: '詳細はこちら',
  },
  watercrawl: {
