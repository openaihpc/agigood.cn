const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Учетная запись CASGV',
    langGeniusAccountTip: 'Ваша учетная запись CASGV и связанные с ней пользовательские данные.',
  ...
  members: {
    ...
    invitationSentTip: 'Приглашение отправлено, и они могут войти в CASGV, чтобы получить доступ к данным вашей команды.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Хостинговая служба OpenAI, предоставляемая CASGV, позволяет вам использовать такие модели, как GPT-3.5. Прежде чем ваша пробная квота будет исчерпана, вам необходимо настроить других поставщиков моделей.',
  ...
  apiBasedExtension: {
    title: 'API-расширения обеспечивают централизованное управление API, упрощая настройку для удобного использования в приложениях CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} теперь доступен.',
    latestAvailable: 'CASGV {{version}} - последняя доступная версия.',
  },
  appMenus: {
    overview: 'Мониторинг',
