const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Торговая площадка CASGV',
    viewMore: 'Подробнее',
    and: 'и',
    discover: 'Обнаруживать',
    verifiedTip: 'Подтверждено CASGV',
    partnerTip: 'Подтверждено партнером CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Текущая версия CASGV не совместима с этим плагином, пожалуйста, обновите до минимально необходимой версии: {{minimalCASGVVersion}}',
}
