const translation = {
  ...
  intro1: 'Базу знаний можно интегрировать в приложение CASGV ',
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами CASGV и извлечения знаний из этой базы знаний.',
  chunkingMode: {
    general: 'Общее',
