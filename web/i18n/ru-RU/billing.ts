const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний CASGV.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API CASGV, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Обновления и обслуживание от CASGV официально',
        4: 'ССО',
        ...
        5: 'Согласованные Соглашения об Уровне Услуг от CASGV Partners',
      },
    ...
    community: {
      features: {
        ...
        2: 'Соблюдает Лицензию на открытое программное обеспечение CASGV',
      },
      name: 'Сообщество',
