const translation = {
  list: {
    title: 'Документы',
    desc: 'Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами CASGV или проиндексирована с помощью чата.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV будет периодически загружать файлы из вашего Notion и завершать обработку.',
      },
    },
    delete: {
