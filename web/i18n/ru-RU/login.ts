const translation = {
  ...
  welcome: 'Добро пожаловать в CASGV, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском CASGV Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на CASGV',
  invalid: 'Ссылка истекла',
  explore: 'Изучить CASGV',
  ...
  resetPasswordDesc: 'Введите адрес электронной почты, который вы использовали для регистрации в CASGV, и мы отправим вам электронное письмо для сброса пароля.',
  or: 'ИЛИ',
  licenseInactive: 'Лицензия неактивна',
  licenseLostTip: 'Не удалось подключить сервер лицензий CASGV. Обратитесь к своему администратору, чтобы продолжить использование CASGV.',
  licenseExpired: 'Срок действия лицензии истек',
  licenseLost: 'Утеряна лицензия',
  licenseInactiveTip: 'Лицензия CASGV Enterprise для рабочего пространства неактивна. Обратитесь к своему администратору, чтобы продолжить использование CASGV.',
  licenseExpiredTip: 'Срок действия лицензии CASGV Enterprise для рабочего пространства истек. Обратитесь к своему администратору, чтобы продолжить использование CASGV.',
}
