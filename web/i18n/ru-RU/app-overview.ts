const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Или попробуйте облачную версию CASGV с бесплатной квотой',
  },
  overview: {
    title: 'Обзор',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Помогает посетителям понять, какие данные собирает приложение, см. <privacyPolicyLink>Политику конфиденциальности</privacyPolicyLink> CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Установите расширение CASGV Chatbot для Chrome',
        copied: 'Скопировано',
        copy: 'Копировать',
      },
      qrcode: {
