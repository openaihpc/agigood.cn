const translation = {
  ...
  otherDataSource: {
    ...
    description: 'В настоящее время база знаний CASGV имеет лишь ограниченные источники данных. Добавление источника данных в базу знаний CASGV — это отличный способ повысить гибкость и возможности платформы для всех пользователей. Наше руководство по вкладу поможет вам легко начать работу. Пожалуйста, нажмите на ссылку ниже, чтобы узнать больше.',
  },
  watercrawl: {
