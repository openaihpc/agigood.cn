const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Опишите, что находится в этой базе знаний. Подробное описание позволяет ИИ своевременно получать доступ к содержимому базы знаний. Если оставить пустым, CASGV будет использовать стратегию поиска по умолчанию.',
