const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'CASGV의 지식베이스 처리 기능을 호출하는 API 호출 수를 나타냅니다.',
    ...
    priceTip: '작업 공간당/',
    apiRateLimitTooltip: 'CASGV API를 통한 모든 요청에는 API 요금 한도가 적용되며, 여기에는 텍스트 생성, 채팅 대화, 워크플로 실행 및 문서 처리가 포함됩니다.',
