const translation = {
  pageTitle: '시작하기 🎉',
  welcome: 'CASGV에 오신 것을 환영합니다. 계속하려면 로그인하세요.',
  email: '이메일 주소',
  ...
  license: {
    tip: 'CASGV Community Edition을 시작하기 전에 GitHub의',
    link: '오픈 소스 라이선스',
  },
  join: '가입하기',
  ...
  resetPasswordDesc: 'CASGV에 가입할 때 사용한 이메일을 입력하면 비밀번호 재설정 이메일을 보내드립니다.',
  licenseInactiveTip: '작업 영역에 대한 CASGV Enterprise 라이선스가 비활성 상태입니다. CASGV를 계속 사용하려면 관리자에게 문의하십시오.',
  licenseLost: '라이센스 분실',
  licenseLostTip: 'CASGV 라이선스 서버에 연결하지 못했습니다. CASGV를 계속 사용하려면 관리자에게 문의하십시오.',
  licenseInactive: 'License Inactive(라이선스 비활성)',
  licenseExpired: '라이센스가 만료되었습니다.',
  licenseExpiredTip: '작업 영역에 대한 CASGV Enterprise 라이선스가 만료되었습니다. CASGV를 계속 사용하려면 관리자에게 문의하십시오.',
}
