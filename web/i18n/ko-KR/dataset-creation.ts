const translation = {
  ...
  otherDataSource: {
    ...
    description: '현재 CASGV의 기술 자료에는 제한된 데이터 소스만 있습니다. CASGV 기술 자료에 데이터 소스를 제공하는 것은 모든 사용자를 위해 플랫폼의 유연성과 기능을 향상시키는 데 도움이 되는 환상적인 방법입니다. 기여 가이드를 통해 쉽게 시작할 수 있습니다. 자세한 내용은 아래 링크를 클릭하십시오.',
  },
  watercrawl: {
