const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: '또는 CASGV의 클라우드 버전을 무료로 체험해보세요',
  },
  overview: {
    title: '개요',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '방문자가 애플리케이션이 수집하는 데이터를 이해하고, CASGV의 <privacyPolicyLink>개인정보 처리방침</privacyPolicyLink>을 참조할 수 있도록 합니다.',
      ...
      embedded: {
        ...
        chromePlugin: 'CASGV Chatbot Chrome 확장 프로그램 설치',
        copied: '복사되었습니다',
        copy: '복사',
      },
      qrcode: {
