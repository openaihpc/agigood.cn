const translation = {
  ...
  marketplace: {
    ...
    empower: 'AI 개발 역량 강화',
    viewMore: '더보기',
    difyMarketplace: 'CASGV 마켓플레이스',
    pluginsResult: '{{num}} 결과',
    discover: '발견하다',
    moreFrom: 'Marketplace에서 더 보기',
    sortBy: '정렬',
    and: '그리고',
    verifiedTip: 'CASGV에 의해 확인됨',
    partnerTip: 'CASGV 파트너에 의해 확인됨',
  },
  task: {
  ...
  difyVersionNotCompatible: '현재 CASGV 버전이 이 플러그인과 호환되지 않습니다. 필요한 최소 버전으로 업그레이드하십시오: {{minimalCASGVVersion}}',
}
