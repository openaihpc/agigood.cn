const translation = {
  ...
  welcome: 'Bienvenue sur CASGV, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer CASGV Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur CASGV',
  invalid: 'Le lien a expiré',
  explore: 'Explorez CASGV',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur CASGV et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence CASGV Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser CASGV.',
  licenseLostTip: 'Échec de la connexion au serveur de licences CASGV. Veuillez contacter votre administrateur pour continuer à utiliser CASGV.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence CASGV Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser CASGV.',
