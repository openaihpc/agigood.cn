const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Actuellement, la base de connaissances de CASGV ne dispose que de sources de données limitées. Contribuer à une source de données dans la base de connaissances CASGV est un moyen fantastique d’améliorer la flexibilité et la puissance de la plateforme pour tous les utilisateurs. Notre guide de contribution facilite la prise en main. Veuillez cliquer sur le lien ci-dessous pour en savoir plus.',
