const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de CASGV avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome CASGV Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Client-Web-CASGV',
