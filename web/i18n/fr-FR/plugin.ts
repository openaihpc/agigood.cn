const translation = {
  ...
  marketplace: {
    ...
    discover: 'Découvrir',
    difyMarketplace: 'Marché CASGV',
    empower: 'Renforcez le développement de votre IA',
    sortBy: 'Ville noire',
    partnerTip: 'Vérifié par un partenaire CASGV',
    verifiedTip: 'Vérifié par CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'La version actuelle de CASGV n\'est pas compatible avec ce plugin, veuillez mettre à niveau vers la version minimale requise : {{minimalCASGVVersion}}',
}
