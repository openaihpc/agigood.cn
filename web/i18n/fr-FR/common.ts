const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte CASGV',
    langGeniusAccountTip: 'Votre compte CASGV et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à CASGV pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par CASGV vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} est maintenant disponible.',
    latestAvailable: 'CASGV {{version}} est la dernière version disponible.',
  },
  appMenus: {
