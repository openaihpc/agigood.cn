const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Fait référence au nombre d\'appels API invoquant uniquement les capacités de traitement de la base de connaissances de CASGV.',
    ...
    apiRateLimitTooltip: 'La limite de taux de l\'API s\'applique à toutes les demandes effectuées via l\'API CASGV, y compris la génération de texte, les conversations de chat, les exécutions de flux de travail et le traitement de documents.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'SLA négociés par CASGV Partners',
        ...
        7: 'Mises à jour et maintenance par CASGV Officiellement',
    ...
    community: {
      features: {
        2: 'Conforme à la licence open source de CASGV',
