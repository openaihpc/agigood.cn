const translation = {
  ...
  intro1: 'La Connaissance peut être intégrée dans l\'application CASGV',
  ...
  externalAPIPanelDescription: 'L’API de connaissances externe est utilisée pour se connecter à une base de connaissances en dehors de CASGV et récupérer des connaissances de cette base de connaissances.',
