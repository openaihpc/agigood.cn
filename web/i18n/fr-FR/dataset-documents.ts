const translation = {
  list: {
    title: 'Documents',
    desc: 'Tous les fichiers de la Connaissance sont affichés ici, et l\'ensemble de la Connaissance peut être lié aux citations CASGV ou indexé via le plugin Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV téléchargera périodiquement des fichiers de votre Notion et terminera le traitement.',
      },
    },
    delete: {
