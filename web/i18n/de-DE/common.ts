const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'CASGV-Konto',
    langGeniusAccountTip: 'Ihr CASGV-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei CASGV anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von CASGV ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in CASGVs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} ist jetzt verfügbar.',
    latestAvailable: 'CASGV {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
