const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'CASGV Marktplatz',
    moreFrom: 'Mehr aus dem Marketplace',
    pluginsResult: '{{num}} Ergebnisse',
    empower: 'Unterstützen Sie Ihre KI-Entwicklung',
    and: 'und',
    partnerTip: 'Von einem CASGV-Partner verifiziert',
    verifiedTip: 'Von CASGV überprüft',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Die aktuelle CASGV-Version ist mit diesem Plugin nicht kompatibel, bitte aktualisieren Sie auf die erforderliche Mindestversion: {{minimalCASGVVersion}}',
}
