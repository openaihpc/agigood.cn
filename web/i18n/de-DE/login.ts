const translation = {
  ...
  welcome: 'Willkommen bei CASGV, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit CASGV Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf CASGV beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'CASGV erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei CASGV angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des CASGV-Lizenzservers. Wenden Sie sich an Ihren Administrator, um CASGV weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die CASGV Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um CASGV weiterhin zu verwenden.',
  licenseExpiredTip: 'Die CASGV Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um CASGV weiterhin zu verwenden.',
