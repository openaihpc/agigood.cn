const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von CASGV aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die CASGV-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'Verhandelte SLAs durch CASGV-Partner',
        7: 'Updates und Wartung von CASGV offiziell',
      },
    ...
    community: {
      features: {
        2: 'Entspricht der CASGV Open Source Lizenz',
