const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Derzeit verfügt die Wissensdatenbank von CASGV nur über begrenzte Datenquellen. Das Beitragen einer Datenquelle zur CASGV-Wissensdatenbank ist eine fantastische Möglichkeit, die Flexibilität und Leistungsfähigkeit der Plattform für alle Benutzer zu verbessern. Unser Beitragsleitfaden erleichtert Ihnen den Einstieg. Bitte klicken Sie auf den untenstehenden Link, um mehr zu erfahren.',
  },
  watercrawl: {
