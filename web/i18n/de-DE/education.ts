const translation = {
  toVerifiedTip: {
    ...
    end: 'für den CASGV Professional Plan.',
  ...
  rejectTitle: 'Ihre CASGV-Ausbildungsüberprüfung wurde abgelehnt.',
  ...
  rejectContent: 'Leider sind Sie nicht für den Status "Education Verified" berechtigt und können daher den exklusiven 100%-Gutschein für den CASGV Professional Plan nicht erhalten, wenn Sie diese E-Mail-Adresse verwenden.',
  successContent: 'Wir haben einen 100% Rabattgutschein für den CASGV Professional Plan auf Ihr Konto ausgestellt. Der Gutschein ist ein Jahr lang gültig, bitte nutzen Sie ihn innerhalb des Gültigkeitszeitraums.',
  learn: 'Erfahren Sie, wie Sie Ihre Ausbildung überprüfen lassen.',
  emailLabel: 'Ihre aktuelle E-Mail',
  successTitle: 'Sie haben die CASGV-Ausbildung verifiziert',
}
