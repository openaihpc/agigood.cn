const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه CASGV ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از CASGV و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
