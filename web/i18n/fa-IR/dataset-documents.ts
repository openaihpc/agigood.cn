const translation = {
  list: {
    title: 'اسناد',
    desc: 'تمامی فایل‌های دانش در اینجا نمایش داده می‌شوند و کل دانش می‌تواند به ارجاعات CASGV متصل شود یا از طریق افزونه چت ایندکس شود.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV به‌طور دوره‌ای فایل‌ها را از Notion شما دانلود و پردازش را کامل می‌کند.',
      },
    },
    delete: {
