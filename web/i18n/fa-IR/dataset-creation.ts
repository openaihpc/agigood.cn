const translation = {
  ...
  otherDataSource: {
    ...
    description: 'در حال حاضر، پایگاه دانش CASGV فقط منابع داده محدودی دارد. کمک به یک منبع داده به پایگاه دانش CASGV راهی فوق العاده برای کمک به افزایش انعطاف پذیری و قدرت پلتفرم برای همه کاربران است. راهنمای مشارکت ما شروع کار را آسان می کند. لطفا برای کسب اطلاعات بیشتر روی لینک زیر کلیک کنید.',
