const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'حساب CASGV',
    langGeniusAccountTip: 'حساب CASGV شما و داده‌های کاربری مرتبط.',
    editName: 'ویرایش نام',
  ...
  members: {
    ...
    invitationSentTip: 'دعوت‌نامه ارسال شد و آنها می‌توانند وارد CASGV شوند تا به داده‌های تیم شما دسترسی پیدا کنند.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'سرویس میزبانی OpenAI ارائه شده توسط CASGV به شما اجازه می‌دهد از مدل‌هایی مانند GPT-3.5 استفاده کنید. قبل از اتمام سهمیه آزمایشی خود، باید سایر ارائه‌دهندگان مدل را تنظیم کنید.',
  ...
  apiBasedExtension: {
    title: 'افزونه‌های مبتنی بر API مدیریت متمرکز API را فراهم می‌کنند و پیکربندی را برای استفاده آسان در برنامه‌های CASGV ساده می‌کنند.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} اکنون در دسترس است.',
    latestAvailable: 'CASGV {{version}} آخرین نسخه در دسترس است.',
  },
  appMenus: {
    overview: 'نظارت',
