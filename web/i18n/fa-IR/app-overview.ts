const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'یا نسخه ابری CASGV با سهمیه رایگان را امتحان کنید',
  },
  overview: {
    title: 'نمای کلی',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'به بازدیدکنندگان کمک می‌کند تا بفهمند برنامه چه داده‌هایی را جمع‌آوری می‌کند، به سیاست حفظ حریم خصوصی CASGV نگاه کنید <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'نصب افزونه Chrome Chatbot CASGV',
        copied: 'کپی شد',
        copy: 'کپی',
      },
      qrcode: {
