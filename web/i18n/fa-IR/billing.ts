const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'به تعداد درخواست‌های API که فقط قابلیت‌های پردازش پایگاه دانش CASGV را فراخوانی می‌کنند اشاره دارد.',
    ...
    apiRateLimitTooltip: 'محدودیت نرخ API برای همه درخواست‌های انجام شده از طریق API CASGV اعمال می‌شود، از جمله تولید متن، محاوره‌های چت، اجرای گردش‌های کار و پردازش اسناد.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA های توافق شده توسط شرکای CASGV',
        4: 'SSO',
