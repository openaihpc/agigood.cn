const translation = {
  ...
  welcome: 'به CASGV خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع CASGV Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در CASGV',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در CASGV استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز CASGV Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از CASGV با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز CASGV Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از CASGV با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز CASGV انجام نشد. لطفا برای ادامه استفاده از CASGV با سرپرست خود تماس بگیرید.',
}
