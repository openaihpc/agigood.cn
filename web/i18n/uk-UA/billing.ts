const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Відноситься до кількості викликів API, що викликають лише можливості обробки бази знань CASGV.',
    ...
    apiRateLimitTooltip: 'Обмеження частоти запитів застосовується до всіх запитів, зроблених через API CASGV, включаючи генерацію тексту, чат-розмови, виконання робочих процесів та обробку документів.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        5: 'Угоди про рівень обслуговування, узгоджені партнерами CASGV',
        ...
        7: 'Оновлення та обслуговування від CASGV Офіційно',
      },
    ...
    community: {
      features: {
        2: 'Відповідає ліцензії CASGV Open Source',
