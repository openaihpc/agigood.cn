const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Наразі база знань CASGV має лише обмежені джерела даних. Додавання джерела даних до бази знань CASGV – це фантастичний спосіб підвищити гнучкість і потужність платформи для всіх користувачів. Наш посібник із внеску спрощує початок роботи. Будь ласка, натисніть на посилання нижче, щоб дізнатися більше.',
  },
  watercrawl: {
