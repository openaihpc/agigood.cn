const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Обліковий запис CASGV',
    langGeniusAccountTip: 'Ваш обліковий запис CASGV та пов’язані з ним дані користувача.',
  ...
  members: {
    ...
    invitationSentTip: 'Запрошення надіслано, і вони можуть увійти в CASGV, щоб отримати доступ до даних вашої команди.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Служба хостингу OpenAI, надана CASGV, дозволяє використовувати такі моделі, як GPT-3.5. Перш ніж ваша пробна квота буде використана, вам потрібно налаштувати інші постачальники моделі.',
  ...
  apiBasedExtension: {
    title: 'API-розширення забезпечують централізоване керування API, спрощуючи конфігурацію для зручного використання в різних програмах CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} тепер доступна.',
    latestAvailable: 'CASGV {{version}} – це найновіша доступна версія.',
  },
  appMenus: {
    overview: 'Моніторинг',
