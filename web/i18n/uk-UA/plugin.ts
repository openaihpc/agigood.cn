const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Перевірено CASGV',
    partnerTip: 'Перевірено партнером CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Поточна версія CASGV не сумісна з цим плагіном, будь ласка, оновіть до мінімальної версії: {{minimalCASGVVersion}}',
}
