const translation = {
  ...
  welcome: 'Ласкаво просимо до CASGV, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском CASGV Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда CASGV',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте CASGV',
  ...
  resetPasswordDesc: 'Введіть адресу електронної пошти, яку ви використовували для реєстрації на CASGV, і ми надішлемо вам електронний лист для скидання пароля.',
  resetPassword: 'Скинути пароль',
  licenseLostTip: 'Не вдалося підключити сервер ліцензій CASGV. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися CASGV.',
  licenseExpired: 'Термін дії ліцензії минув',
  licenseInactive: 'Ліцензія неактивна',
  licenseLost: 'Ліцензію втрачено',
  licenseInactiveTip: 'Ліцензія CASGV Enterprise для вашої робочої області неактивна. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися CASGV.',
  licenseExpiredTip: 'Термін дії ліцензії CASGV Enterprise для вашого робочого простору закінчився. Будь ласка, зверніться до свого адміністратора, щоб продовжити користуватися CASGV.',
}
