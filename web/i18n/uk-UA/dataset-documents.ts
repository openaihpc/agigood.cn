const translation = {
  list: {
    title: 'Документи',
    desc: 'Тут відображаються всі файли Знання, і все Знання можна зв’язати з цитатами CASGV або проіндексувати за допомогою плагіна Chat.',
    addFile: 'додати файл',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV періодично завантажуватиме файли з вашого Notion і завершуватиме обробку.',
      },
    },
    delete: {
