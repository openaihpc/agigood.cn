const translation = {
  ...
  intro1: 'Знання можна інтегрувати до програми CASGV ',
  intro2: 'як контекст',
  intro3: ',',
  intro4: 'або його ',
  ...
  externalAPIPanelDescription: 'API зовнішніх знань використовується для підключення до бази знань за межами CASGV і отримання знань із цієї бази знань.',
  chunkingMode: {
