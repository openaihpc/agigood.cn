const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of CASGV with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see CASGV\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Install CASGV Chatbot Chrome Extension',
        copied: 'Copied',
        copy: 'Copy',
      },
      qrcode: {
