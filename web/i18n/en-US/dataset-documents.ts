const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to CASGV citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
