const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by CASGV',
    partnerTip: 'Verified by a CASGV partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current CASGV version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalCASGVVersion}}',
}
