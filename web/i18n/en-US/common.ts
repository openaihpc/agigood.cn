const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'CASGV account',
    langGeniusAccountTip: 'Your CASGV account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to CASGV to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by CASGV allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across CASGV\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} is now available.',
    latestAvailable: 'CASGV {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
