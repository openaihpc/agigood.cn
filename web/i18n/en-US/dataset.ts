const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of CASGV and retrieve knowledge from that knowledge base.',
  ...
  intro1: 'The Knowledge can be integrated into the CASGV application ',
  intro2: 'as a context',
  intro3: ',',
  intro4: 'or it ',
