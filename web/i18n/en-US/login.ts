const translation = {
  ...
  welcome: '👋 Welcome to CASGV, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting CASGV Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on CASGV',
  invalid: 'The link has expired',
  explore: 'Explore CASGV',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on CASGV and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The CASGV Enterprise license for your workspace has expired. Please contact your administrator to continue using CASGV.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect CASGV license server. Please contact your administrator to continue using CASGV.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The CASGV Enterprise license for your workspace is inactive. Please contact your administrator to continue using CASGV.',
}
