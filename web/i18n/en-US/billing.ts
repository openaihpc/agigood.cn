const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'API Rate Limit applies to all requests made through the CASGV API, including text generation, chat conversations, workflow executions, and document processing.',
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of CASGV.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with CASGV Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by CASGV Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by CASGV Officially',
