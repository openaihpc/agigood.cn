const translation = {
  list: {
    title: 'Documente',
    desc: 'Toate fișierele din Cunoștințe sunt afișate aici, iar întreaga Cunoaștere poate fi legată de citări CASGV sau indexată prin intermediul pluginului Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV va descărca periodic fișiere din Notion și va finaliza procesarea.',
      },
    },
    delete: {
