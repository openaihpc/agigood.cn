const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cont CASGV',
    langGeniusAccountTip: 'Contul CASGV și datele de utilizator asociate.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitația a fost trimisă și pot să se autentifice în CASGV pentru a accesa datele echipei dvs.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Serviciul de găzduire OpenAI furnizat de CASGV vă permite să utilizați modele precum GPT-3.5. Înainte ca cota de probă să fie epuizată, trebuie să configurați alți furnizori de modele.',
      callTimes: 'Apeluri',
  ...
  apiBasedExtension: {
    title: 'Extensiile bazate pe API oferă o gestionare centralizată a API-urilor, simplificând configurația pentru o utilizare ușoară în aplicațiile CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} este acum disponibil.',
    latestAvailable: 'CASGV {{version}} este ultima versiune disponibilă.',
  },
  appMenus: {
