const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a CASGV cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome CASGV Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
