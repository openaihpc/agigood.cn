const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se referă la numărul de apeluri API care invocă doar capacitățile de procesare a bazei de cunoștințe a CASGV.',
    ...
    apiRateLimitTooltip: 'Limita de rată API se aplică tuturor cererilor efectuate prin API-ul CASGV, inclusiv generarea de texte, conversațiile de chat, execuțiile fluxului de lucru și procesarea documentelor.',
  },
  plans: {
    sandbox: {
      name: 'Sandbox',
    ...
    enterprise: {
      ...
      features: {
        ...
        4: 'SSO',
        7: 'Actualizări și întreținere de către CASGV Oficial',
        1: 'Autorizare pentru licență comercială',
        5: 'SLA-uri negociate de partenerii CASGV',
    ...
    community: {
      features: {
        2: 'Se conformează Licenței Open Source CASGV',
