const translation = {
  ...
  welcome: 'Bine ai venit la CASGV, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe CASGV Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe CASGV și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe CASGV. Contactați administratorul pentru a continua să utilizați CASGV.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența CASGV Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați CASGV.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența CASGV Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați CASGV.',
}
