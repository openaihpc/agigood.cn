const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Piața CASGV',
    moreFrom: 'Mai multe din Marketplace',
    and: 'și',
    viewMore: 'Vezi mai mult',
    partnerTip: 'Verificat de un partener CASGV',
    verifiedTip: 'Verificat de CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Versiunea curentă CASGV nu este compatibilă cu acest plugin, vă rugăm să faceți upgrade la versiunea minimă necesară: {{minimalCASGVVersion}}',
}
