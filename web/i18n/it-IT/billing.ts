const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      'Si riferisce al numero di chiamate API che invocano solo le capacità di elaborazione della base di conoscenza di CASGV.',
    receiptInfo:
    ...
    apiRateLimitTooltip: 'Il limite di utilizzo dell\'API si applica a tutte le richieste effettuate tramite l\'API CASGV, comprese la generazione di testo, le conversazioni chat, le esecuzioni di flussi di lavoro e l\'elaborazione di documenti.',
    getStarted: 'Inizia',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        5: 'SLA negoziati da CASGV Partners',
        0: 'Soluzioni di distribuzione scalabili di livello enterprise',
        7: 'Aggiornamenti e manutenzione di CASGV ufficialmente',
    ...
    community: {
      features: {
        ...
        2: 'Rispetta la Licenza Open Source di CASGV',
