const translation = {
  ...
  form: {
    ...
    descPlaceholder:
      'Descrivi cosa c\'è in questa Conoscenza. Una descrizione dettagliata permette all\'IA di accedere al contenuto della Conoscenza in modo tempestivo. Se vuota, CASGV utilizzerà la strategia di recupero predefinita.',
