const translation = {
  ...
  otherDataSource: {
    ...
    description: 'Attualmente, la knowledge base di CASGV ha solo fonti di dati limitate. Contribuire con una fonte di dati alla knowledge base di CASGV è un modo fantastico per migliorare la flessibilità e la potenza della piattaforma per tutti gli utenti. La nostra guida ai contributi ti aiuta a iniziare. Clicca sul link sottostante per saperne di più.',
  },
  watercrawl: {
