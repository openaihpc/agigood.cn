const translation = {
  list: {
    title: 'Documenti',
    desc: 'Tutti i file della Conoscenza sono mostrati qui, e l\'intera Conoscenza può essere collegata alle citazioni di CASGV o indicizzata tramite il plugin di Chat.',
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV scaricherà periodicamente i file dal tuo Notion e completerà l\'elaborazione.',
      },
    },
    delete: {
