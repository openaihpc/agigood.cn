const translation = {
  ...
  welcome: 'Benvenuto su CASGV, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare CASGV Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su CASGV',
  invalid: 'Il link è scaduto',
  explore: 'Esplora CASGV',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su CASGV e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze CASGV. Contatta il tuo amministratore per continuare a utilizzare CASGV.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza CASGV Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare CASGV.',
  licenseInactiveTip: 'La licenza CASGV Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare CASGV.',
