const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'O prova la versione cloud di CASGV con quota gratuita',
  },
  overview: {
    title: 'Panoramica',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Aiuta i visitatori a capire i dati raccolti dall\'applicazione, vedi la <privacyPolicyLink>Privacy Policy</privacyPolicyLink> di CASGV.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installa l\'estensione Chrome di CASGV Chatbot',
        copied: 'Copiato',
        copy: 'Copia',
      },
      qrcode: {
