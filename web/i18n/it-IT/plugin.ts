const translation = {
  ...
  marketplace: {
    ...
    verifiedTip: 'Verificato da CASGV',
    partnerTip: 'Verificato da un partner CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'L\'attuale versione di CASGV non è compatibile con questo plugin, si prega di aggiornare alla versione minima richiesta: {{minimalCASGVVersion}}',
}
