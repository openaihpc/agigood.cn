const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account CASGV',
    langGeniusAccountTip: 'Il tuo account CASGV e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a CASGV per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da CASGV ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di CASGV.',
  ...
  about: {
    ...
    nowAvailable: 'CASGV {{version}} è ora disponibile.',
    latestAvailable: 'CASGV {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
