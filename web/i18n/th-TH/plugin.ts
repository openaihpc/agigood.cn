const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'ตลาด CASGV',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ CASGV',
    verifiedTip: 'ได้รับการตรวจสอบโดย CASGV',
  },
  task: {
  ...
  difyVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ CASGV ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalCASGVVersion}}',
}
