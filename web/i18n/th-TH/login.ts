const translation = {
  ...
  welcome: '👋 ยินดีต้อนรับสู่ CASGV โปรดเข้าสู่ระบบเพื่อดําเนินการต่อ',
  email: 'ที่อยู่อีเมล',
  ...
  license: {
    tip: 'ก่อนเริ่ม CASGV Community Edition โปรดอ่าน GitHub',
    link: 'ใบอนุญาตโอเพ่นซอร์ส',
  },
  join: 'ต่อ',
  joinTipStart: 'เชิญคุณเข้าร่วม',
  joinTipEnd: 'ทีมงานใน CASGV',
  invalid: 'ลิงก์หมดอายุ',
  explore: 'สํารวจ CASGV',
  ...
  resetPasswordDesc: 'พิมพ์อีเมลที่คุณใช้ลงทะเบียนบน CASGV แล้วเราจะส่งอีเมลรีเซ็ตรหัสผ่านให้คุณ',
  ...
  licenseExpiredTip: 'สิทธิ์การใช้งาน CASGV Enterprise สําหรับพื้นที่ทํางานของคุณหมดอายุแล้ว โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ CASGV ต่อไป',
  licenseLost: 'ใบอนุญาตสูญหาย',
  licenseLostTip: 'เชื่อมต่อเซิร์ฟเวอร์ใบอนุญาต CASGV ไม่สําเร็จ โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ CASGV ต่อไป',
  licenseInactive: 'ใบอนุญาตไม่ใช้งาน',
  licenseInactiveTip: 'สิทธิ์การใช้งาน CASGV Enterprise สําหรับพื้นที่ทํางานของคุณไม่ได้ใช้งาน โปรดติดต่อผู้ดูแลระบบของคุณเพื่อใช้ CASGV ต่อไป',
}
