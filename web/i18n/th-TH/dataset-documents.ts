const translation = {
  list: {
    title: 'เอกสาร',
    desc: 'ไฟล์ทั้งหมดของความรู้จะแสดงที่นี่ และความรู้ทั้งหมดสามารถเชื่อมโยงกับการอ้างอิง CASGV หรือจัดทําดัชนีผ่านปลั๊กอินแชท',
    addFile: 'เพิ่มไฟล์',
    addPages: 'เพิ่มหน้า',
    addUrl: 'เพิ่ม URL',
    table: {
    ...
    empty: {
      ...
      sync: {
        tip: 'CASGV จะดาวน์โหลดไฟล์จาก Notion ของคุณเป็นระยะและดําเนินการให้เสร็จสมบูรณ์',
      },
    },
    delete: {
