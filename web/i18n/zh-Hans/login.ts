const translation = {
  ...
  license: {
    tip: '启动 CASGV 社区版之前, 请阅读 GitHub 上的',
    link: '开源协议',
  },
  join: '加入 ',
  joinTipStart: '邀请你加入 ',
  ...
  licenseExpiredTip: '您所在空间的 CASGV Enterprise 许可证已过期，请联系管理员以继续使用 CASGV。',
  licenseLost: '许可证丢失',
  licenseLostTip: '无法连接 CASGV 许可证服务器，请联系管理员以继续使用 CASGV。',
  licenseInactive: '许可证未激活',
  licenseInactiveTip: '您所在空间的 CASGV Enterprise 许可证尚未激活，请联系管理员以继续使用 CASGV。',
}
