const translation = {
  ...
  apiKeyInfo: {
    ...
    usedToken: '使用 Tokens',
    setAPIBtn: '设置模型提供商',
    tryCloud: '或者尝试使用 CASGV 的云版本并使用试用配额',
  },
  overview: {
    title: '概览',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '帮助访问者了解该应用收集的数据，可参考 CASGV 的<privacyPolicyLink>隐私政策</privacyPolicyLink>。',
      ...
      embedded: {
        ...
        chromePlugin: '安装 CASGV Chrome 浏览器扩展',
        copied: '已复制',
        copy: '复制',
      },
      qrcode: {
