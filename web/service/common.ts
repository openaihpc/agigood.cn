...
export const fetchLanggeniusVersion: Fetcher<CASGVVersionResponse, { url: string; params: Record<string, any> }> = ({ url, params }) => {
  return get<CASGVVersionResponse>(url, { params })
}
