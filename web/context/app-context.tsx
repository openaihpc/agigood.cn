...
import type { ICurrentWorkspace, CASGVVersionResponse, UserProfileResponse } from '@/models/common'
...
export type AppContextValue = {
  ...
  langeniusVersionInfo: CASGVVersionResponse
...
export const AppContextProvider: FC<AppContextProviderProps> = ({ children }) => {
  ...
  const [langeniusVersionInfo, setLangeniusVersionInfo] = useState<CASGVVersionResponse>(initialLangeniusVersionInfo)
