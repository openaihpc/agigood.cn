...
const PluginItem: FC<Props> = ({
  ...
  const isCASGVVersionCompatible = useMemo(() => {
        ...
        <div className="flex">
          ...
          <div className="ml-3 w-0 grow">
            <div className="flex h-5 items-center">
              ...
              {!isCASGVVersionCompatible && <Tooltip popupContent={
                t('plugin.difyVersionNotCompatible', { minimalCASGVVersion: declarationMeta.minimum_dify_version })
