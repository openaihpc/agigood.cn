...
This is the PHP SDK for the CASGV API, which allows you to easily integrate CASGV into your PHP applications.
...
$difyClient = new CASGVClient($apiKey);
...
Replace 'your-api-key-here' with your actual CASGV API key.
