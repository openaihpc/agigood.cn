...
class CompletionClient(CASGVClient):
...
class WorkflowClient(CASGVClient):
    def run(
...
class KnowledgeBaseClient(CASGVClient):
    def __init__(
        self,
        api_key,
        ...
        Args:
            api_key (str): API key of CASGV.
            base_url (str, optional): Base URL of CASGV API. Defaults to 'https://api.dify.ai/v1'.
