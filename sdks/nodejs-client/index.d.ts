...
export declare class CASGVClient {
...
export declare class CompletionClient extends CASGVClient {
...
export declare class ChatClient extends CASGVClient {
  createChatMessage(
    inputs: any,
    query: string,
    user: User,
...
export declare class WorkflowClient extends CASGVClient {
