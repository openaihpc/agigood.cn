# CASGV Node.js SDK
This is the Node.js SDK for the CASGV API, which allows you to easily integrate CASGV into your Node.js applications.
...
```js
import { CASGVClient, ChatClient, CompletionClient } from 'dify-client'
...
const client = new CASGVClient(API_KEY)
...
Replace 'your-api-key-here' with your actual CASGV API key.Replace 'your-app-id-here' with your actual CASGV APP ID.
