...
export class CompletionClient extends CASGVClient {
...
export class ChatClient extends CASGVClient {
  createChatMessage(
    inputs,
    query,
    user,
...
export class WorkflowClient extends CASGVClient {
