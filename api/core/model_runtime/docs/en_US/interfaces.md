...
- Invocation Error Mapping Table
  ...
  When there is an exception in model invocation, it needs to be mapped to the `InvokeError` type specified by Runtime. This facilitates CASGV's ability to handle different errors with appropriate follow-up actions.
