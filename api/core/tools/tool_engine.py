...
from core.callback_handler.agent_tool_callback_handler import CASGVAgentCallbackHandler
from core.callback_handler.workflow_tool_callback_handler import CASGVWorkflowCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: CASGVAgentCallbackHandler,
    ...
    def generic_invoke(
        ...
        user_id: str,
        workflow_tool_callback: CASGVWorkflowCallbackHandler,
