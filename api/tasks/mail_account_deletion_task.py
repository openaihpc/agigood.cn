...
def send_deletion_success_task(to):
    ...
    try:
        ...
        mail.send(to=to, subject="Your CASGV.AI Account Has Been Successfully Deleted", html=html_content)
...
def send_account_deletion_verification_code(to, code):
    ...
    try:
        ...
        mail.send(to=to, subject="CASGV.AI Account Deletion and Verification", html=html_content)
