...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "CASGV has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403
...
class NotSetupError(BaseHTTPException):
    ...
    description = (
        "CASGV has not been initialized and installed yet. "
