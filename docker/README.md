...
Welcome to the new `docker` directory for deploying CASGV using Docker Compose. This README outlines the updates, deployment instructions, and migration details for existing users.
...
### How to Deploy CASGV with `docker-compose.yaml`
...
### How to Deploy Middleware for Developing CASGV
